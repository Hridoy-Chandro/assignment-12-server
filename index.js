...
async function run() {
  try {
    ...
    const serviceCollection = client.db("My-Task").collection("service");
    const reviewCollection = client.db("My-Task").collection("reviews");
    const peopleCollection = client.db("My-Task").collection("people");
